...
/**
 * Centralized pagination handler for all MCP Server endpoints.
...
public class PaginationHandler {
    ...
    /**
     * Calculate whether more pages exist.
     * Uses totalCount if available, otherwise uses heuristic (full page = more exist).
     *
    ...
    /**
     * Merge multiple warning lists with result message.
     * Ensures all messages are visible to the AI.
     *
