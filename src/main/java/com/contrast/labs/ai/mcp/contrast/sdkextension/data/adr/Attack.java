...
public class Attack {
  ...
  private List<String>
      attackers; // List of authenticated user identifiers (usernames/user IDs) involved in the
  // attack
  private int id;
  private String uuid;
  ...
  private String
      application_importance; // Valid values: "UNIMPORTANT", "LOW", "MEDIUM", "HIGH", "CRITICAL"
