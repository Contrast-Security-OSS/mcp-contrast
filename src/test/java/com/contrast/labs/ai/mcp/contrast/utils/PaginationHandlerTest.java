...
class PaginationHandlerTest {
    ...
    void testCreatePaginatedResponse_withTotalCount_lastPage() {
        ...
        assertEquals(3, response.pageSize());
        assertEquals(10, response.totalItems());
        assertFalse(response.hasMorePages(), "Should not have more pages (page 4 * pageSize 3 = 12 >= 10)");
    ...
    void testCreatePaginatedResponse_withoutTotalCount_fullPage() {
        ...
        assertTrue(response.hasMorePages(), "Full page without totalCount suggests more pages exist (heuristic)");
    }
    ...
    void testCreatePaginatedResponse_mergesWarningsWithEmptyMessage() {
        ...
        assertNotNull(response.message());
        assertTrue(response.message().contains("Requested pageSize 200 exceeds maximum 100"),
                  "Should include pageSize warning");
        assertTrue(response.message().contains("Requested page 2 exceeds available pages"),
